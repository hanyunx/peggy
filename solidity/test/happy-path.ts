...
describe("Gas tests", function() {
  ...
  it("testVerifyECDSA in isolation", async function() {
    const signers = await ethers.getSigners();
    const peggyId = ethers.utils.formatBytes32String("foo");
  ...
  it("testVerifyECDSA in isolation", async function() {
    ...
    await peggy.testEmptyBLS();
  });

  it("testVerifyBLS in isolation", async function() {
    const signers = await ethers.getSigners();
    const peggyId = ethers.utils.formatBytes32String("foo");
    ...
    await peggy.testVerifyBLS();
  });

  it("testVerifyBGLS2 in isolation", async function() {
    const signers = await ethers.getSigners();
    const peggyId = ethers.utils.formatBytes32String("foo");
    ...
    await peggy.testVerifyBGLS2();
  });

  it("testVerifyBGLS3 in isolation", async function() {
    const signers = await ethers.getSigners();
    const peggyId = ethers.utils.formatBytes32String("foo");
